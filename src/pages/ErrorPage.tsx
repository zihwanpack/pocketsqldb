...
const ErrorPage: React.FC = () => {
  return (
    <section className="h-screen flex flex-row justify-center items-center gap-20">
      <img className="w-[400px]" src="pikachu-voltage-road-sign-512x512.png" alt="경고하는 피카츄 그림" />
